...
RSpec.describe SnippetsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested snippet as @snippet" do
      snippet = Snippet.create! valid_attributes
      get :show, params: {id: snippet.to_param}, session: valid_session
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved snippet as @snippet" do
        post :create, params: {snippet: invalid_attributes}, session: valid_session
        expect(assigns(:snippet)).to be_a_new(Snippet)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested snippet" do
        snippet = Snippet.create! valid_attributes
        put :update, params: {id: snippet.to_param, snippet: new_attributes}, session: valid_session
        snippet.reload
      ...
      it "assigns the requested snippet as @snippet" do
        snippet = Snippet.create! valid_attributes
        put :update, params: {id: snippet.to_param, snippet: valid_attributes}, session: valid_session
        expect(assigns(:snippet)).to eq(snippet)
      end
    ...
    context "with invalid params" do
      it "assigns the snippet as @snippet" do
        snippet = Snippet.create! valid_attributes
        put :update, params: {id: snippet.to_param, snippet: invalid_attributes}, session: valid_session
        expect(assigns(:snippet)).to eq(snippet)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested snippet" do
      snippet = Snippet.create! valid_attributes
      expect {
        delete :destroy, params: {id: snippet.to_param}, session: valid_session
      }.to change(Snippet, :count).by(-1)
    end
